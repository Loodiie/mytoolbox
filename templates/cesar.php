        ...
        <div class="row">
            <figure class="bg-light rounded p-3">
                <blockquote>
                    ...
                    <p>
                        Le code César consiste à substituer une lettre par une autre un plus loin dans l'alphabet,
                        c'est-à-dire qu'une lettre est toujours remplacée par la même lettre et que l'on applique le même décalage à toutes les lettres,
                        cela rend très simple le décode d'un message puisqu'il y a 25 décalages possibles.
                    </p>
                </blockquote>
                ...
                <form action="" method="POST" name="cesar">
                    <div class="form-group row">
                        ...
                        <div class="col-12 mt-4">
                            ...
                            <p id="clear" style="overflow-wrap: break-word;"></p>
                        </div>
